...
7. Review gate:
   ...
   - Treat a response prefixed `[agy quota exhausted — auto-routed to Vertex gemini-3.5-flash on project <vertex-project>]` as a valid Gemini reviewer response, not as a degradation. Record the route in the review summary.
