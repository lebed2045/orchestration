...
- Generated Codex workflow scratch belongs under `codex/.agents/codex/temp/`; keep that path gitignored. Codex research belongs under `codex/.agents/codex/research/`. Claude research remains under `.claude/research/`.
