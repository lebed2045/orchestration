...
| Command | Description |
|---------|-------------|
| `/wf` | The workflow. Fast TDD on modern primitives (Agent + worktree + tier-auto). Prints `wf v19 (10-jun-2026)` as its first line on every invocation. |
...
.codex/temp/              # Generated by Codex $wf
.codex/research/          # Generated by Codex $research and $think
```
