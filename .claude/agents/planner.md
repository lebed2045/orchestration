...
Transform `artifacts/spec.md` into a detailed architecture document that a developer can follow.

## Process

### Step 1: Read the Specification

Read `artifacts/spec.md` completely. Understand:
...
Create `artifacts/architecture.md` with this structure:
...
5. **Output to artifacts/architecture.md** - this is your deliverable
...
1. `artifacts/spec.md` has been read
2. `artifacts/architecture.md` is written
