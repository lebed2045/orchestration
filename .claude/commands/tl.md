---
description: "Tweet-size summary of the previous assistant output, with clickable next-action buttons. Use when the user runs /tl or asks for a TLDR of the last response."
argument-hint: "[text or pointer to summarize]"
---
...
0. **Help banner.** Print exactly this line first:

   `/tl — tweet-size summary of the last assistant output, with clickable next-action buttons.`
